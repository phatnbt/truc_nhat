...
function bindStaticEvents(){
  ...
  // Firestore onSnapshot handles realtime changes. These two hooks restore/verify state
  // automatically after reconnecting or returning to the app, without any manual sync button.
...
async function registerPwa(){if(!("serviceWorker" in navigator)||location.protocol==="file:")return;try{const reg=await navigator.serviceWorker.register("./sw.js?v=20260819-3",{scope:"./"});setTimeout(()=>reg.update().catch(()=>{}),1500);}catch(e){console.warn("PWA",e);}}
