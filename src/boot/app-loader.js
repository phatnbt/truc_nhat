import { createP708SecureEngine } from "../core/p708-secure-sync-engine.js?v=20260921-5";
...
import * as P708CleaningStreak from "../core/cleaning-streak.js?v=20260921-5";
...
const parts = [
  "../core/app-core1.js?v=20260921-5",
  "../core/app-core2.js?v=20260913-1",
  "../features/app-actions1.js?v=20260921-5",
  ...
  "../features/cleaning-pet-streak.js?v=20260921-5",
  ...
  "../features/home-pet-garden.js?v=20260921-5",
  "../features/ui-icon-polish.js?v=20260913-2",
  "./app-start.js?v=20260921-5",
