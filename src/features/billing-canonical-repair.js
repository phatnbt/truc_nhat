(()=>{
  ...
  persist=async function(message,audit={}){
    ...
    try{
      ...
      console.error("P708 canonical billing repair",error);
      restoreConfirmedState();
      ...
      try{
        ...
        console.warn("P708 canonical repair recovery",syncError);
      }
      return false;
    }finally{
  ...
  syncBillingMembers=async function(){
    ...
    try{
      ...
      expectedRevision=null;
      beforeRepairPayload=null;
      console.error("P708 prepare canonical billing repair",error);
